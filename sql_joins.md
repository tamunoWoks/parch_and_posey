## SQL Joins
Here we will try out some examples for different SQL joinss such as `INNER JOIN`, `LEFT JOIN`, `RIGHT JOIN` and `OUTER JOIN` alongside other concepts like `ALIAS`, Primary keys and Foreign keys.  
