## Basic SQL
Here we will try out some examples for Basic SQL concepts such as , `SELECT`, `FROM`, `LIMIT`, `WHERE`, `IN`, `ORDER BY`, `NOT`, `AND`, `BETWEEN`, `OR` alongside Arithmetic and Logical operators.  
